...
def main():
    ...
    for row in wb["Complete Schedule"].iter_rows(min_row=2, values_only=True):
        ...
        kind = "mock" if topic.startswith("Mock Oral Boards") else ("clinical" if codes else "professional")  # kind is now hand-maintained in data/curriculum.json (clinical is split into surgical/office/imaging/anatomy)
